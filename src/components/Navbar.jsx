"use client"; // This is required for interactivity like buttons
      ...
      <div className="container flex justify-between h-16 mx-auto">
        ...
        <ul className="items-stretch hidden space-x-3 lg:flex">
          <li className="flex">
            <Link
              href="/"
              className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent dark:text-violet-600 dark:border-violet-600"
            >
              Home
            </Link>
          </li>
